    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to right, rgba(0,27,61,0.92) 0%, rgba(0,27,61,0.65) 55%, rgba(0,27,61,0.15) 100%)",
          }}
        />
      </div>
      ...
      >
        ...
        <motion.div
          style={{
            width: "40px",
            height: "40px",
            background: "rgba(29,117,217,0.6)",
          }}
          animate={{ y: [0, -14, 0] }}
          transition={{
            duration: 3,
      ...
      >
        ...
        >
          ...
          >
            Chúng tôi luôn luôn tin tưởng và nỗ lực phấn đấu hết mình nhằm cung
            cấp các sản phẩm, dịch vụ hoàn hảo mang lại giá trị cho khách hàng,
            cho xã hội.
          </p>
