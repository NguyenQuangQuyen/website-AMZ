        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            <p className="text-white/70 text-base leading-relaxed font-medium">
              Chúng tôi tự hào là công ty cung cấp dịch vụ hiện đại và uy tín hàng đầu tại Việt Nam. 
              Hãy chia sẻ với chúng tôi những vấn đề mà doanh nghiệp của bạn đang gặp phải, 
              chúng tôi sẵn sàng cung cấp các giải pháp và phần mềm hiện đại, tối ưu nhất cho bạn.
            </p>
          </motion.div>
