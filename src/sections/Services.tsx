...
const services = [
  {
    icon: (
      ...
      >
        ...
        <path d="M7 8h.01M11 8h6M7 12h10" />
      </svg>
    ),
  ...
  },
  {
    ...
    desc: "Cung cấp các giải pháp hạ tầng máy chủ, lưu trữ trên nền tảng đám mây, giúp doanh nghiệp tối ưu chi phí và dễ dàng mở rộng quy mô linh hoạt.",
  },
  {
    icon: (
      <svg
    ...
    desc: "Ứng dụng AI và Học máy để tự động hóa quy trình, tối ưu hóa trải nghiệm khách hàng và tạo ra lợi thế cạnh tranh đột phá cho doanh nghiệp.",
  },
];
...
export default function Services() {
  ...
  return (
    <section
      style={{
        background:
          "linear-gradient(135deg,#e8edf5 0%,#f0f4fa 50%,#dde4f0 100%)",
        padding: "80px 0 60px",
        position: "relative",
        overflow: "hidden",
      }}
              ...
              {visible.map((s, i) => (
                <motion.div
                  ...
                  variants={{
                    ...
                    hover: {
                      y: -8,
                      boxShadow: "0 20px 40px rgba(29,117,217,0.35)",
                    },
                  }}
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      right: 0,
                      height: "3px",
                      background: "linear-gradient(90deg,#1d75d9,#0dcaf0)",
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      height: "64px",
                      borderRadius: "50%",
                      background: "linear-gradient(135deg,#1d75d9,#0dcaf0)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      color: "#fff",
            ...
            {Array.from({ length: totalPages }).map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: "8px",
                  borderRadius: "9999px",
                  background: i === page ? "#1d75d9" : "#b0bec5",
                  border: "none",
                  cursor: "pointer",
                  transition: "all 0.3s",
                  padding: 0,
