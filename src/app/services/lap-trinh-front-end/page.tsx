...
const techStack = [
  { label: "Vue js", image: "/images/Vue.png" },
  { label: "Java", image: "/images/java.png" },
  { label: "Angular", image: "/images/angular.png" },
  { label: "React js", image: "/images/Reactjs.png" },
  { label: "Html", image: "/images/html.jpg" },
  { label: "Node js", image: "/images/nodejs.png" },
  { label: "Css", image: "/images/css.svg" },
  { label: "Wordpress", image: "/images/WordPress.png" },
];
...
export default function LapTrinhFrontEndPage() {
  return (
    <>
      <Header />
      <main>
        ...
        >
          ...
          >
            ...
            <span>›</span>
            <span style={{ color: "#fff" }}>Lập Trình Front End</span>
          </motion.div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Chúng tôi xây dựng giao diện người dùng hiện đại, tối ưu hiệu suất
              và trải nghiệm người dùng. Đội ngũ Front End của chúng tôi thành
              thạo các framework và công nghệ mới nhất để tạo ra những sản phẩm
              đẹp và mượt mà.
            </p>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Nhóm của chúng tôi, bao gồm các chuyên gia UX/UI, lập trình
                  viên Front End giàu kinh nghiệm, cung cấp một bộ kỹ năng toàn
                  diện. Từ việc thiết kế giao diện đến tối ưu hiệu suất, chúng
                  tôi đảm bảo sản phẩm hoạt động mượt mà trên mọi thiết bị và
                  trình duyệt.
                </p>
                <hr
                  style={{
