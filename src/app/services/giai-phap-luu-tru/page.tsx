...
const techStack = [
  { label: "My SQL", image: "/images/My SQL.png" },
  { label: "Oracle", image: "/images/Oracle.png" },
  { label: "SQLServer", image: "/images/SQLServer.png" },
  { label: "Mariadb", image: "/images/Mariadb.png" },
];
...
export default function GiaiPhapLuuTruPage() {
  return (
    <>
      <Header />
      <main>
        ...
        >
          ...
          >
            ...
            <span>›</span>
            <span style={{ color: "#fff" }}>Giải pháp lưu trữ</span>
          </motion.div>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Hỗ trợ khách hàng giảm chi phí CNTT và nâng cao chất lượng
                  dịch vụ, giải pháp AMZ tạo điều kiện hợp nhất trên các đám mây
                  cơ sở dữ liệu, đảm bảo hoạt động hiệu quả và tiết kiệm chi
                  phí.
                </p>
                <hr
                  style={{
