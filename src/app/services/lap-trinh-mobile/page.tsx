...
const techStack = [
  ...
  { label: "Kotlin", image: "/images/Kotlin.png" },
  { label: "Objective-C", image: "/images/Objective-C.png" },
  { label: "Swift", image: "/images/swift.svg" },
  { label: "Xamarin", image: "/images/Xamarin.png" },
  { label: "React Native", image: "/images/React Native.png" },
  { label: "Appcelerator", image: "/images/Appcelerator.svg" },
];
...
export default function LapTrinhMobilePage() {
  return (
    <>
      <Header />
      <main>
        ...
        >
          ...
          >
            ...
            <span>›</span>
            <span style={{ color: "#fff" }}>Lập Trình Mobile</span>
          </motion.div>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Nhóm của chúng tôi, bao gồm các nhà phân tích kinh doanh,
                  chuyên gia UX/UI, kiến trúc sư, lập trình viên, người kiểm
                  tra, DevOps và quản lý viên, cung cấp một bộ kỹ năng toàn
                  diện. Từ việc lên ý tưởng và thiết kế ứng dụng đến phát triển,
                  bảo trì và đảm bảo chức năng liền mạch, chúng tôi cung cấp các
                  dịch vụ Xây dựng và nâng cấp ứng dụng Mobile toàn diện để đáp
